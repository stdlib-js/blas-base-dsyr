...
var B=require('@stdlib/blas-base-assert-is-layout/dist'),G=require('@stdlib/blas-base-assert-is-matrix-triangle/dist'),H=require('@stdlib/ndarray-base-assert-is-column-major-string/dist'),I=require('@stdlib/strided-base-stride2offset/dist'),J=require('@stdlib/math-base-special-fast-max/dist'),h=require('@stdlib/error-tools-fmtprodmsg/dist'),K=p();function P(a,r,e,i,u,s,o,n){var t,g,l;if(!B(a))throw new TypeError(h('1ybFx',a));if(!G(r))throw new TypeError(h('1ybGA',r));if(e<0)throw new RangeError(h('1ybFz',e));if(s===0)throw new RangeError(h('1ybGB',s));if(n<J(1,e))throw new RangeError(h('1ybGM',e,n));return e===0||i===0?o:(H(a)?(t=1,g=n):(t=n,g=1),l=I(e,s),K(r,e,i,u,s,l,o,t,g,0))}T.exports=P
